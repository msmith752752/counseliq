...
from institutional_positioning_engine import build_institutional_positioning_intelligence
...
def _safe_get_company_intelligence(ticker: str):
    try:
        ...
        institutional_positioning = build_institutional_positioning_intelligence(ticker)
        ...
        return {
            ...
            "executive_risk_interpretation": executive_risk[
                "executive_risk_interpretation"
            ],

            "institutional_positioning_level": institutional_positioning[
                "institutional_positioning_level"
            ],
            "institutional_positioning_signals": institutional_positioning[
                "institutional_positioning_signals"
            ],
            "institutional_positioning_interpretation": institutional_positioning[
                "institutional_positioning_interpretation"
            ],
        ...
        return {
            ...
            "executive_risk_level": "Unavailable",
            "status": "error",
            "error": str(error),
        }
...
def generate_market_brief(tickers=None):
    ...
    ranked_company_briefs = sorted(
        company_briefs,
        key=lambda item: item.get("executive_risk_score", 0),
        reverse=True,
    )
    ...
    return {
        ...
        "top_executive_risk": top_risk,
        "ranked_company_briefs": ranked_company_briefs,
        "counseliq_summary": (
            "CounselIQ now combines executive risk, quiet signals, filing changes, "
            "leadership interpretation, and institutional positioning intelligence."
        ),
    }